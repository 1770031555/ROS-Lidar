...
class projector {
    private:
        ...
        void sensor_info_callback_3(const sensor_msgs::Image::ConstPtr &img,
                                    const darknet_ros_msgs::BoundingBoxes::ConstPtr& msg);


        void sensor_info_callback_1(const sensor_msgs::Image::ConstPtr &img,
                                  const sensor_msgs::PointCloud2::ConstPtr &pc);

        void sensor_info_callback_2(const sensor_msgs::Image::ConstPtr &img,
                                 const sensor_msgs::PointCloud2::ConstPtr &pc);
//                                  const darknet_ros_msgs::BoundingBoxesConstPtr& bd_boxes);

        void sensor_info_callback_4(
        ...
        void organized_pointcloud(pcl::PointCloud<pcl::PointXYZ>::Ptr input_pointcloud,
